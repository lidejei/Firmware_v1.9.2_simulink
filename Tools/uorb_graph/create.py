...
class Graph(object):
    ...
    ('mc_att_linear_pid', r'mc_att_linear_pid_main\.cpp$', r'\b_actuators_id=([^,)]+)', r'^_actuators_id$'),
    ('mc_att_linear_pid', r'mc_att_linear_pid_main\.cpp$', r'\_attitude_sp_id=([^,)]+)', r'^_attitude_sp_id$'),
